<?php
    ob_start();
    session_start();
    // $_SESSION['username'] = "";  $_SESSION['username'] != "LoginSuccess"
...
<header>
    <nav class="navbar">
        <ul class="menu">
            ...
            <li class="menu-item"><a href="FiberOrder/indexOrder.php" tite="Logout">Search Fiber orders</a></li>
            <li class="menu-item" type="button">Login</li>
            <a href="Test/logout.php" tite="Logout">Logout.</a>
        </ul>
    </nav>
</header>
...
<body>
    ...
    <div class="col-md-12" style="display: inline-block;">
        ...
        <div class="col-md-1" style="display: inline-block;">
            <button type="button" id="Searchbtn" onclick="SearchEmp()"
        ...
        <div style="margin-left: 50px;" id="demo" class="collapse">
            <form action="insert.php" method="post">
                ...
                <div class="row" style="margin-top: 10px;">
                    EmployeeID : <input type="text" id="employeeId" name="empID" style="margin-left: 7px;"
                        class="form-control col-md-4" placeholder="EmployeeID">
                </div>
                <div class="row" style="margin-top: 10px;">
                ...
                <div class="row" style="margin-top: 10px;">
                    Last Name : <input type="text" id="empLastName" name="LName" style="margin-left: 17px;"
                        class="form-control col-md-4" placeholder="Last Name">
                </div>
                <div class="row" style="margin-top: 10px;">
                    Add By : <input type="text" id="addBy" name="addBy" style="margin-left: 40px;"
                        class="form-control col-md-4" placeholder="Add By">
                </div>
                <div class="row" style="margin-top: 10px;">
                    Date : <input type="date" id="addDate" name="date" style="margin-left: 57px;"
                        class="form-control col-md-4" placeholder="Date">
                </div>
                <br>
